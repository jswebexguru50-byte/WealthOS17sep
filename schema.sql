...
-- Generated: 2026-09-25T08:00:42.115Z
-- Source: portfolio.db (DDL Only - 0 Data Rows)
-- Total Schema Objects: 328
-- ================================================================
...
-- [TABLE] DatasetPromotionManifests
...
-- [TABLE] InvestmentCandidates
CREATE TABLE InvestmentCandidates (
...
CREATE TABLE OpportunityScripEvaluations (
          ...
          , provenance_tag TEXT DEFAULT 'SOURCED: NSE_PRIMARY', confidence_interval_str TEXT DEFAULT '±2.5%', scan_id TEXT, origin TEXT);
...
CREATE TABLE ValuationSnapshots (
      ...
      drift_alert TEXT,
      created_at TEXT DEFAULT CURRENT_TIMESTAMP
    , aif_value REAL NOT NULL DEFAULT 0, unlisted_value REAL NOT NULL DEFAULT 0, observationDate TEXT, observationTimestamp TEXT, timestampPrecision TEXT);
...
-- [INDEX] idx_master_status_exchange_symbol
CREATE INDEX idx_master_status_exchange_symbol ON MasterTickers(status, exchange, symbol);
...
-- [INDEX] idx_snapshot_symbol_date
CREATE INDEX idx_snapshot_symbol_date ON MarketSnapshots(symbol, snapshot_date DESC);
